...
const Footer = () => {
  return (
    <footer className="flex justify-center  border-t-1  bg-foreground text-background light  ">
      <div className="grid max-w-screen-2xl grid-cols-1 gap-10 px-8 py-14 sm:gap-36 md:grid-cols-3 lg:px-5 ">
